...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TalkProposal.special_requirements'
        db.add_column(u'proposals_talkproposal', 'special_requirements',
                      self.gf('markitup.fields.MarkupField')(default='', no_rendered_field=True, blank=True),
                      keep_default=False)

        # Adding field 'TalkProposal._special_requirements_rendered'
        db.add_column(u'proposals_talkproposal', '_special_requirements_rendered',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'TutorialProposal.special_requirements'
        db.add_column(u'proposals_tutorialproposal', 'special_requirements',
                      self.gf('markitup.fields.MarkupField')(default='', no_rendered_field=True, blank=True),
                      keep_default=False)

        # Adding field 'TutorialProposal._special_requirements_rendered'
        db.add_column(u'proposals_tutorialproposal', '_special_requirements_rendered',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TalkProposal.special_requirements'
        db.delete_column(u'proposals_talkproposal', 'special_requirements')

        # Deleting field 'TalkProposal._special_requirements_rendered'
        db.delete_column(u'proposals_talkproposal', '_special_requirements_rendered')

        # Deleting field 'TutorialProposal.special_requirements'
        db.delete_column(u'proposals_tutorialproposal', 'special_requirements')

        # Deleting field 'TutorialProposal._special_requirements_rendered'
        db.delete_column(u'proposals_tutorialproposal', '_special_requirements_rendered')
    ...
    models = {
        ...
        u'proposals.talkproposal': {
            ...
            '_special_requirements_rendered': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'audience_level': ('django.db.models.fields.IntegerField', [], {}),
            u'proposalbase_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['proposals.ProposalBase']", 'unique': 'True', 'primary_key': 'True'}),
            'recording_release': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'special_requirements': ('markitup.fields.MarkupField', [], {'no_rendered_field': 'True', 'blank': 'True'})
        },
